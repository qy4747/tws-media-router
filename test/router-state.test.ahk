...
AssertEqual(smtc.HandleAction("pause", false, 1150), "pause-confirmed", "self Pause confirmation is surfaced immediately")
...
AssertEqual(retry.HandleAction("pause", false, 5090), "pause-confirmed", "Pause acknowledgement is surfaced immediately")
...
AssertEqual(retry.HandleAction("pause", false, 5120), "pause-confirmed", "forced Pause acknowledgement is surfaced")
